...
# Project-specific scripts directory (PSSD) location
LOC_PSFILES_DIR <- "out"
...
# 
# Set relative to BASEDIR, defined in 
# general params file (params.R)
######################################
######################################
...
RAWDATADIR <- paste0( DATA_BASEDIR_PROJ, 'raw/')   # Shared raw data directory
